...
stringtie ${aligned} -o ~/data/mgura/${folder}/gtfs/${OUTPUT}.gtf -G /users/mgura/data/mgura/genomes/Mouse/UCSC_mm10_Mus_musculus/UCSC_mm10_genes.gtf -l ${OUTPUT} -A ~/data/mgura/${folder}/tabs/${OUTPUT}.tab -e
done
